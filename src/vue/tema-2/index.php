...
<div class="wrapper">
    ...
    <main class="mainContent">
        ...
        <article class="sectionIntro">
            <header>
                <h2>Trazabilidad de elementos usando v-for</h2>
            </header>
        ...
        <article class="sectionIntro">
            <header>
                <h2>Ejercicio resumen del Tema 2</h2>
            </header>
